...
namespace xmreg
{
    ...
    CmdLineOptions::CmdLineOptions(int acc, const char *avv[]) {
        ...
        options_description desc(
                "xmrblocks, Makoto Blockchain Explorer");
        ...
        desc.add_options()
                ...
                ("enable-emission-monitor", value<bool>()->default_value(false)->implicit_value(true),
                 "enable Makoto total emission monitoring thread")
                ...
                ("bc-path,b", value<string>(),
                 "path to lmdb folder of the blockchain, e.g., ~/.makoto/lmdb")
                ...
                ("deamon-url,d", value<string>()->default_value("http:://127.0.0.1:17968"),
                 "Makoto deamon url");
