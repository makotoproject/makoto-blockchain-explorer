var config = {
    ...
    coinUnitPlaces: 12,
    txMinConfirms: 10,         // corresponds to CRYPTONOTE_DEFAULT_TX_SPENDABLE_AGE in Makoto
    txCoinbaseMinConfirms: 60, // corresponds to CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW in Makoto
    coinSymbol: 'MKT',
    openAliasPrefix: "mkt",
    coinName: 'Makoto',
    coinUriPrefix: 'Makoto:',
